...
async def cb_cfg_help(callback: CallbackQuery) -> None:
    ...
    text = (
        ...
        "📊 <b>Дашборд</b> — статистика за день / неделю / месяц + аналитика\n"
        "➕ <b>Новая запись</b> — мастер: услуга → дата → время → клиент\n"
        "👤 <b>Клиенты</b> — история визитов и расходов каждого клиента\n"
        "⏰ <b>Напоминания</b> — авто-напоминание за X ч + сводка на завтра\n\n"
        "<b>Тап по записи → карточка:</b>\n"
        "✅ Пришёл · 🚫 Не пришёл · 💰 Оплата\n"
        "✏️ Перенести · 📝 Заметка · ❌ Отменить\n\n"
        "<b>Просто напиши мне:</b>\n"
        "• «запиши Катю на стрижку 20 мая в 14:00»\n"
        "• «перенеси Катю на 21-е в 15:00»\n\n"
        "📧 <b>Почта</b> — пересылает письма от букинг-сервисов\n"
        "Настроить: ⚙️ Настройки → Интеграции → 📧 Email\n\n"
